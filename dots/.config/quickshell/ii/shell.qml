...
ShellRoot {
    ...
    property var panelFamilies: ({
        ...
        "waffle": ["wActionCenter", "wBar", "wLock", "wNotificationCenter", "wNotificationPopup", "wOnScreenDisplay", "wTaskView", "wPolkit", "wScreenSnip", "wSessionScreen", "wStartMenu", "iiCheatsheet", "iiOnScreenKeyboard", "iiOverlay", "iiWallpaperSelector"],
    })
